...
/* Generated from ../O.Common/autoOnOff.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_initTraceRegister, pvar_func_sncExampleRegistrar,
...
int autoOnOff_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/long/Epics/apps/AutoOnOff";
...
/* autoOnOff_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"autoOnOff_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    autoOnOff_registerRecordDeviceDriver(*iocshPpdbbase);
}
